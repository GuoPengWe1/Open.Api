...
namespace Open.Tool.BaseClass.BaseRepositories
{
    /// <summary>
    /// 泛型仓储，实现泛型仓储接口
    /// </summary>
    ...
    public abstract class BaseRepository<T> : IRepository<T>/*, ITransientDependency */where T : class
    {
        ...
        ///// <returns></returns>
        //public virtual async Task<IEnumerable<T>> GetFieldsListWhereAsync(string selFields = " * ", string where = null, IDbTransaction trans = null)
        //{
        ...
        //    }
        //    string sql = $"select {selFields} from {tableName} ";
        ...
        ///// <param name="where"></param>
        ///// <returns></returns>
        //public virtual IList<T> GetList(Expression<Func<T, bool>> @where = null)
        //{
        ...
        //{
        //    if (entity.KeyIsNull() && typeof(TKey) != typeof(int))
        //    {
